...
contextBridge.exposeInMainWorld("settingsAPI", {
  ...
  listGames: () => ipcRenderer.invoke("settings:list-games"),
  launchGame: (gameId) => ipcRenderer.invoke("settings:launch-game", gameId),
  clearGameSaves: (gameId) => ipcRenderer.invoke("settings:clear-game-saves", gameId),
  getMeritStatus: () => ipcRenderer.invoke("settings:get-merit-status"),
  ...
  browsePetdexPets: (query) => ipcRenderer.invoke("settings:browse-petdex-pets", query),
  adoptPetdexPet: (slug) => ipcRenderer.invoke("settings:adopt-petdex-pet", slug),
